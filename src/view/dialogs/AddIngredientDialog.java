...
public class AddIngredientDialog extends JDialog {
    ...
    public AddIngredientDialog(Frame owner, RestaurantController controller) {
        super(owner, "Add New Ingredient", true);
    ...
    private void initComponents() {
        ...
        gbc.gridx = 0;
        gbc.gridy = 2;
        mainPanel.add(new JLabel("Initial Quantity:"), gbc);
